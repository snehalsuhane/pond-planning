...
Delineates the upstream catchment area (watershed) for a specific pour point 
...
def delineate_watershed(
    ...
    """
    Delineate the watershed for a given pour point.
    ...
    -------
    dict:
        polygon_lonlat : list of [lon, lat] coordinates representing the boundary
        area_m2        : float, total area of the watershed in square metres
    """
